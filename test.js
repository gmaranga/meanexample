...
var URL_ROOT = 'http://'+process.env.IP+':3000';
...
describe('Part 3 Assessment Tests', function() {
  ...
  it('gets the correct Facebook auth keys', function(done) {
    ...
    assert.equal(require('passport')._strategies['google']._clientSecret,
      config.facebookClientSecret);
      console.log("-->>" + require('passport')._strategies['google']._clientSecret);
      console.log("-->>" + config.facebookClientSecret);
    ++succeeded;
    done();
  });
